...
public class Board {
	 ...
	 * -게시글 번호, 제목, 내용, 작성자, 작성일, 조회수, 좋아요 수, 게시글 타입(공지사항, 뉴스 등)
	 * 1. 게시글 등록
	 * 2. 게시글 수정
	 * 3. 게시글 삭제
	 * 4. 게시글 목록 확인
	 ...
	 */
	private int num;
	private String title = ""; //String은 new를 안써도 선언 가능
	...
	*/
	...
	/* 기능	 : 게시글 정보 요약(번호 제목 작성자 작성일)해서 출력하는 메소드
	 * 매개변수: 없음
	 * 리턴타입: void
	 * 메소드명: summaryPrint
	*/
	...
	/* 기능	 : 제목과 내용을 수정하는 메소드
	 * 매개변수: String title, String contents
	 * 리턴타입: void
	 * 메소드명: update
	*/
