...
CREATE TABLE `review` (
  ...
  `re_totalSc` float NOT NULL DEFAULT '0',
  `re_service` int NOT NULL DEFAULT '0',
  `re_mood` int NOT NULL DEFAULT '0',
  `re_tasty` int NOT NULL DEFAULT '0',
...
-- Dump completed on 2021-08-09 17:25:16
