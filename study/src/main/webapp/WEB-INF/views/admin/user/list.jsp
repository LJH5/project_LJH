<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %> <!-- 이거 있어야 c태그 사용 가능 -->
	...
	<table class="table table-striped table-hover">
		<thead>
			<tr>
				...
				<th>
					<a href="<%=request.getContextPath()%>/admin/user/list?sortType=authority&sort=${pm.criteria.sort}">
						<span>등급</span>
