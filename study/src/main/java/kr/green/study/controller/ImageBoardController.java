...
public class ImageBoardController {
	...
	public ModelAndView listGet(ModelAndView mv, Criteria cri) {
		cri.setType("IMAGE"); // IMAGE 타입의 파일만 불러온다 
	...
	@PostMapping("/detail") //비밀번호가 노출되면 안돼서 포스트에서 처리
	...
	@PostMapping("/modify")
	public ModelAndView modifyPost(ModelAndView mv, BoardVO board, HttpServletRequest request, MultipartFile[] fileList, Integer [] fileNumList, MultipartFile mainImage, Integer thumbnailNo) throws Exception {
		MemberVO user = memberService.getMemberByRequest(request);
