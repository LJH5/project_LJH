...
CREATE TABLE `recommend` (
  ...
  CONSTRAINT `rc_me_id` FOREIGN KEY (`rc_me_id`) REFERENCES `member` (`me_id`),
  CONSTRAINT `rc_re_num` FOREIGN KEY (`rc_re_num`) REFERENCES `review` (`re_num`)
...
-- Dump completed on 2021-09-06 17:49:23
